...
## 시스템 플로우차트 📊
### 전체 기능 플로우차트
아래 다이어그램은 ULM의 전체적인 기능 흐름을 보여줍니다. 사용자 로그인부터 캐릭터 생성, 캠퍼스 탐험, 미니게임 플레이까지의 전체 프로세스를 한눈에 파악할 수 있습니다.

<img width="100%" src="Thumbnail/전체플로우차트.png"/>

### 기능 도식도
ULM의 핵심 기능들을 모듈화하여 표현한 도식도입니다. 각 기능들이 어떻게 상호작용하며 전체 시스템을 구성하는지 보여줍니다.

<img width="100%" src="Thumbnail/기능도식도.jpg"/>

### 서버 플로우차트
멀티플레이어 기능을 위한 서버 통신 흐름을 보여주는 다이어그램입니다. Photon PUN2를 활용한 실시간 네트워킹과 음성 채팅 시스템의 동작 방식을 설명합니다.

<img width="100%" src="Thumbnail/네트워크플로우차트.png"/>
